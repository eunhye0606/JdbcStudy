...
--5. 데이터(직원 정보) 입력 쿼리
INSERT INTO TBL_EMP(EMP_ID,EMP_NAME,SSN,IBSADATE,CITY_ID,TEL,BUSEO_ID,JIKWI_ID,BASICPAY,SUDANG)
VALUES(EMPSEQ.NEXTVAL,'신하리','960812-2345678',TO_DATE('2000-04-05','YYYY-MM-DD')
    ,(SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울')
    ,'010-1234-1234'
    ,(SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부')
    ,(SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원')
...
-->
INSERT INTO TBL_EMP(EMP_ID,EMP_NAME,SSN,IBSADATE,CITY_ID,TEL,BUSEO_ID,JIKWI_ID,BASICPAY,SUDANG) VALUES(EMPSEQ.NEXTVAL,'신하리','960812-2345678',TO_DATE('2000-04-05','YYYY-MM-DD') ,(SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울') ,'010-1234-1234' ,(SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부') ,(SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원') ,80000000,600000);
--==>>1 행 이(가) 삽입되었습니다.
...
--7. 전체 직원 리스트 조회 쿼리문
/*
SELECT EMP_ID,EMP_NAME,SSN ,IBSADATE , CITY_ID , TEL, BUSEO_ID,JIKWI_ID,BASICPAY
    ,SUDANG
FROM TBL_EMP;
*/


SELECT E.EMP_ID,E.EMP_NAME,E.SSN
        ,(TO_CHAR(E.IBSADATE,'YYYY-MM-DD')) AS IBSADATE
        ,C.CITY_NAME, E.TEL
        ,B.BUSEO_NAME,J.JIKWI_NAME,E.BASICPAY
        ,E.SUDANG
...
--9. 직원 전체 출력 쿼리문(사번/이름/부서/직위/급여 내림차순)
...
SET EMP_NAME = '김민성', SSN = '970725-1234567'
    ...
    ,CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '경기')
    ,TEL = '010-3333-2222'
...
WHERE EMP_ID = 1030;
-->
UPDATE TBL_EMP SET EMP_NAME = '김민성', SSN = '970725-1234567' ,IBSADATE = TO_DATE('2021-07-20','YYYY-MM-DD') ,CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '경기') ,TEL = '010-3333-2222' ,BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '기획부') ,JIKWI_ID=(SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원') ,BASICPAY = 3000000 ,SUDANG = 2000000 WHERE EMP_ID = 1030
;
